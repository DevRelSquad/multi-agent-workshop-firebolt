...
- **Email Delivery**: Beautiful HTML emails with branded footer (Google for Developers × Firebolt × DevRelSquad)
...
- **Branded footer** featuring: Google for Developers × Firebolt × DevRelSquad
...
4. Check console for "📧 Email Preview (Sandbox Mode)" output
...
<Checkpoint items={[
  ...
  "HTML email template includes branded footer (Google for Developers × Firebolt × DevRelSquad)",
