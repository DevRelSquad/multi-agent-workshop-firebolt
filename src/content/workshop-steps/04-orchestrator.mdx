...
Look for the `TODO: Exercise 1` comment in the file. Implement the `executeQuery` method that:
...
Look for the `TODO: Exercise 2` comment in the file. Implement:
...
Look for the `TODO: Exercise 3` comment in the file. Add a `getCustomerGrowth()` method to the `AnalyticsAgent` class that:
...
Look for the `TODO: Exercise 4` comment in the file. Add a `getConversionFunnel()` method that:
